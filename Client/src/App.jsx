...
const BrainCircuit = (props) => (
  ...
  >
    <path d="M12 2a2.5 2.5 0 0 0-2.5 2.5v.75a.5.5 0 0 1-1 0V4.5A2.5 2.5 0 0 0 6 2a2.5 2.5 0 0 0-2.5 2.5v15A2.5 2.5 0 0 0 6 22a2.5 2.5 0 0 0 2.5-2.5v-1.75a.5.5 0 0 1 1 0v1.75A2.5 2.5 0 0 0 12 22a2.5 2.5 0 0 0 2.5-2.5v-15A2.5 2.5 0 0 0 12 2Z" />
    <path d="M4.5 12h15" />
    <path d="M5 4.75a.5.5 0 0 1 1 0V11a.5.5 0 0 1-1 0Z" />
    <path d="M8.5 4.75a.5.5 0 0 1 1 0v5.5a.5.5 0 0 1-1 0Z" />
    <path d="M15.5 12.75a.5.5 0 0 1 1 0v5.5a.5.5 0 0 1-1 0Z" />
    <path d="M19.5 4.75a.5.5 0 0 1 1 0V8a.5.5 0 0 1-1 0Z" />
  </svg>
);
const Mic = (props) => (
  <svg
  ...
  return (
    <div className="bg-black text-slate-300 font-sans antialiased">
      ...
      >
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-bold text-white">Agentic</h1>
          </div>
          <button className="bg-violet-600 hover:bg-violet-500 text-white font-bold py-2 px-5 rounded-lg transition-colors shadow-lg shadow-violet-500/10 text-sm transform hover:scale-105">
            Request Access
          </button>
        </div>
      </header>
      ...
      <main className="relative overflow-hidden">
        <div className="absolute top-[-10rem] left-1/2 -translate-x-1/2 w-[50rem] h-[50rem] bg-violet-900/30 rounded-full filter blur-3xl opacity-30 animate-[pulse_8s_cubic-bezier(0.4,0,0.6,1)_infinite]"></div>
      ...
      <footer className="border-t border-slate-800/50 py-12">
        <div className="container mx-auto px-6 text-center text-slate-500">
          ...
          <p className="text-sm">
            &copy; {new Date().getFullYear()} Agentic. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
